...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def forward(self, input_ids, position_ids=None, token_type_ids=None, past=None):
        ...
        presents = []
        all_hidden_states = [hidden_states.clone()]
        ...
        all_hidden_states.pop() # ignore the last layer prior to layer norm
        all_hidden_states.append(hidden_states.clone())

        output_shape = input_shape + (hidden_states.size(-1),)
        return hidden_states.view(*output_shape), presents, all_hidden_states
